  ...
  <div class="service-section-1__grid">
    ...
    ?>
      <?php if ($left_image_acf) : ?>
        <a href="<?php echo esc_url($left_url); ?>" class="service-section-1__project-teaser service-section-1__project-teaser--left fade-in">
    ...
    ?>
      <?php if ($right_image_acf) : ?>
        <a href="<?php echo esc_url($right_url); ?>" class="service-section-1__project-teaser service-section-1__project-teaser--right fade-in">
          <div class="service-section-1__project-image hover-round">
